...
const orderRoute = (ordersCollection) => {
  // ================= GET =================
  router.get("/api/penguin/get-order-list", verifyJWT, async (req, res) => {
    try {
  ...
  router.get(
    "/api/penguin/get-order-list/:email",
    verifyJWT,
    async (req, res) => {
      try {
    ...
    async (req, res) => {
      try {
        ...
        const data = {
          ...
          card_exp_date:
            typeof card_exp_date === "string" ? card_exp_date : null,
          ...
          bkash_trns_no:
            typeof bkash_trns_no === "string" ? bkash_trns_no : null,
  ...
  // ================= DELETE =================
  router.delete(
    "/api/admin/delete-order-list/:id",
    verifyJWT,
    async (req, res) => {
      try {
